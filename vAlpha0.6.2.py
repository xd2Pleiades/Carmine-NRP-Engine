#!/usr/bin/env python3
"""
Carmine NRP Engine - vAlpha0.6.2
New in 0.6.2: tithe income for Regnum Dei, planet/district removal with confirm,
              trade route builder/editor in MARKET tab, history.json, graph overlay
"""
...
def main():
    ...
    pygame.init(); pygame.display.set_caption("Carmine NRP Engine - vAlpha0.6.2")
    ...
    load_nation(0); set_status(f"Carmine v0.6.2  ~=GM console  loaded: {filepath}",CYAN)
    running=True
    while running:
