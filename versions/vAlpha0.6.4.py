#!/usr/bin/env python3
"""
Carmine NRP Engine - vAlpha0.6.4
...
class UnitBuilderOverlay:
    ...
    def _make_fields(self,u,nation_names):
        ...
        groups=["Unassigned"]+[g["name"] for g in (u.get("_all_groups") or [])]
        gi=0
        self.fields=[
...
def main():
    ...
    pygame.init(); pygame.display.set_caption("Carmine NRP Engine - vAlpha0.6.4")
    ...
    load_nation(0); set_status(f"Carmine v0.6.4  ~=GM console  loaded: {filepath}",CYAN)
    running=True
    while running:
